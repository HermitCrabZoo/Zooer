    ...
    public static void main(String[] args) {
        ...
        FilenameFilter imgFilter = new FilenameFilter() {
            public boolean accept(File dir, String name) {
                ...
                return name.endsWith(".jpg") ||name.endsWith(".jpeg") || name.endsWith(".pgm") || name.endsWith(".png");
            }
        };
        ...
        for (File image : imageFiles) {
            ...
            System.out.println(Arrs.join(",", Pather.shortName(image.getName()).split("\\_")));
            int label = Integer.parseInt(Pather.shortName(image.getName()).split("\\_")[1]);
        ...
        int l=faceRecognizer.predict_label(testImage);
