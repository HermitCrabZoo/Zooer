...
public final class Colors {
     ...
     * 判断给定颜色是否是给定色系
     *
     * @param color  需要判断的Color对象
     * @param chroma 色系
     * @return true表示color是chroma色系，否则false
     */
    public static boolean isChroma(Color color, Chroma chroma) {
        return (color != null && chroma != null) && chroma.in(getYuv(color).getY());
    }
     ...
     *
     * @param argb argb分量的int值
     * @return argb分量的int值数组
     */
